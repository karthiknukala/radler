...
def init_project(name=None, path=None, **_):
...
'''
    ...
    talker_h_template = f'''#ifndef TALKER_H
#define TALKER_H
...
'''
    ...
    talker_cpp_template = f'''#include "talker.h"
#include <iostream>
...
'''
    ...
    listener_h_template = f'''#ifndef LISTENER_H
#define LISTENER_H
...
'''
    ...
    listener_cpp_template = f'''#include "listener.h"
#include <iostream>
